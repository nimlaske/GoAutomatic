        ...
        <section className="border-b border-white/10 bg-neutral-950">
          <div className="mx-auto max-w-6xl px-6 py-20 md:py-28">
            ...
            <h1 className="max-w-3xl text-5xl font-semibold leading-tight text-white md:text-7xl">
              Turn Everyday Admin Into Automated Follow-Up.
            </h1>
            <p className="mt-6 max-w-2xl text-base leading-7 text-neutral-300">
              We help small businesses automate common customer tasks, so your team spends
              less time repeating answers and more time closing real opportunities.
            </p>

            <ul className="mt-8 space-y-2 text-sm text-neutral-200 md:text-base">
              <li>• Frequently asked customer questions handled automatically.</li>
              <li>• Simple follow-up flows so fewer leads go cold.</li>
              <li>• Repeatable marketing tasks scheduled with less manual effort.</li>
            </ul>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                WhatsApp for a Free 15-Min Audit
              </a>
              <a
                href="#problem"
